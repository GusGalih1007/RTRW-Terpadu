        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 banner-one-img text-center ms-2 ms-sm-0">
                    <img src="{{ asset('landing-pages/assets/images/home-1/banner-top.webp') }}" alt="RT/RW Terpadu Hero"
                        class="img-fluid">
                </div>
                <div class="col-lg-5 inner-box">
                    ...
                    <h1 class="text-secondary heading-title text-capitalize">RT/RW <span class="text-primary">Terpadu</span>
                    </h1>
                    <p class="title-text">Sistem manajemen warga, iuran, dan program RT/RW yang terintegrasi untuk
                        memudahkan administrasi lingkungan Anda.</p>
                    ...
                    <div class="star-box mt-4">
                        <div class="d-flex mb-2 align-items-center">
                            ...
                            <img src="{{ asset('landing-pages/assets/images/home-1/13.webp') }}" alt="Rating"
            ...
            <div class="row mx-2 mx-sm-0">
                ...
                <div class="col-lg-6 top-feature">
                    <div class="text-right">
                        ...
                        <h2 class="text-white notch-feature-txt heading-title text-capitalize heading-title">Fitur Terbaik
                            untuk Administrasi RT/RW</h2>
                        <p class="title-text mb-0">Sistem terintegrasi yang memudahkan pengelolaan data warga, iuran,
                            program, dan administrasi lingkungan Anda.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{ asset('landing-pages/assets/images/home-1/aboutus.webp') }}" alt="Tentang Kami"
                        class="img-fluid">
                </div>
                <div class="col-md-6">
                    ...
                    <h2 class="text-secondary text-capitalize heading-title">Solusi <span
                            class="text-primary">Terpadu</span> untuk Administrasi Lingkungan</h2>
                    <p class="mb-4">RT/RW Terpadu adalah sistem manajemen terintegrasi yang dirancang khusus untuk
                        memudahkan administrasi lingkungan Anda. Dengan fitur-fitur canggih dan antarmuka yang
                        user-friendly, kami membantu RT/RW dalam mengelola data warga, pembayaran iuran, program lingkungan,
                        dan berbagai aspek administrasi lainnya.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <h2 class="text-secondary heading-title text-capitalize">Cocok untuk <span class="text-primary">Semua
                            Pihak</span></h2>
                    <p class="title-text">RT/RW Terpadu dirancang untuk memenuhi kebutuhan berbagai pihak dalam
                        administrasi lingkungan.</p>
                    <ul class="list-unstyled mt-4">
                        <li class="mb-3">
                            <svg class="text-primary me-2" width="20" height="20" viewBox="0 0 20 20"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.6667 5L7.50001 14.1667L3.33334 10" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <strong>Admin (Kelurahan):</strong> Memantau data warga di seluruh RT/RW, verifikasi peran, dan
                            menerima laporan
                        </li>
                        <li class="mb-3">
                            <svg class="text-primary me-2" width="20" height="20" viewBox="0 0 20 20"
                ...
                <div class="col-lg-7 mt-5 mt-lg-0">
                    <img src="{{ asset('landing-pages/assets/images/home-1/dwn-1.webp') }}" alt="Untuk Siapa"
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    ...
                    <h2 class="text-secondary heading-title text-capitalize">Proses <span
                            class="text-primary">Sederhana</span> dan Efisien</h2>
                    <p class="heading-main-title">Dari pendaftaran hingga pembayaran, semua proses dirancang untuk
                        kemudahan dan efisiensi.</p>
                </div>
            </div>
            <div class="row mt-5">
                            ...
                            <div class="bg-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-3"
                                ...
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke-linejoin="round" />
                                    <path d="M20 21C20 18.7909 17.9543 17 15.3333 17H8.66667C6.04567 17 4 18.7909 4 21"
                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    ...
                    <h2 class="text-secondary heading-title text-capitalize">Apa Kata <span
                            class="text-primary">Pengguna</span> Kami?</h2>
                </div>
                <div class="overflow-hidden slider-circle-btn" id="testimonial-slider">
                    <ul class="p-0 m-0 swiper-wrapper list-inline">
                        <li class="swiper-slide">
                            <p class="mb-4 test-text">"Sistem RT/RW Terpadu sangat membantu dalam mengelola administrasi
                                lingkungan kami. Semua data warga tercatat dengan rapi dan pembayaran iuran menjadi lebih
                                teratur."</p>
                            <div class="text-center">
                                <img src="{{ asset('assets/images/dashboard/top-header3.png') }}"
                                    class="img-fluid rounded-pill user-test-img mt-2 mb-2" alt="Testimoni 1"
                        ...
                        <li class="swiper-slide">
                            <p class="mb-4 test-text">"Sebagai petugas iuran, saya sangat terbantu dengan fitur QR Code.
                                Sekarang saya bisa langsung mengecek status pembayaran warga hanya dengan memindai QR Code
                                mereka."</p>
                            <div class="text-center">
                                <img src="{{ asset('assets/images/dashboard/top-header4.png') }}"
                                    class="img-fluid rounded-pill user-test-img mt-2 mb-2" alt="Testimoni 2"
                                    style="max-width: 150px;">
                            </div>
                            <div class="mb-2 text-center">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        <li class="swiper-slide">
                            <p class="mb-4 test-text">"Sebagai warga, saya merasa lebih mudah dalam membayar iuran dan
                                melihat program-program yang ada di lingkungan kami. Transparansi menjadi lebih baik."</p>
                            <div class="text-center">
                                <img src="{{ asset('assets/images/dashboard/top-header5.png') }}"
                                    class="img-fluid rounded-pill user-test-img mt-2 mb-2" alt="Testimoni 3"
                                    style="max-width: 150px;">
                            </div>
                            <div class="mb-2 text-center">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    ...
                    <h2 class="text-secondary heading-title text-capitalize">Siap <span
                            class="text-primary">Mengelola</span> Lingkungan Anda?</h2>
                    <p class="heading-main-title">Bergabunglah dengan RT/RW Terpadu dan rasakan kemudahan dalam
                        administrasi lingkungan Anda.</p>
                    <div class="mt-5">
                        <a href="{{ route('auth.login') }}" class="btn btn-primary btn-lg me-4">Login
                            Sekarang</a><br><br>
                        <a href="{{ route('auth.register.rt-rw') }}" class="btn btn-secondary btn-lg">Daftar Gratis
                            sebagai Ketua RT/RW</a><br><br>
                        <a href="{{ route('auth.register.warga') }}" class="btn btn-secondary btn-lg">Daftar Gratis
                            sebagai Warga</a>
                    </div>
                </div>
            </div>
