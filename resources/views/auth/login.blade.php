                ...
                <div class="col-md-10">
                    <div class="card card-transparent auth-card d-flex justify-content-center mb-0 shadow-none">
                        <div class="card-body">
                            ...
                            <p class="text-center">Masukkan Email dan password anda untuk menggunakan layanan kami</p>
                            <form action="{{ route('auth.login.post') }}" method="POST">
                                ...
                                <p class="mt-3 text-center">
                                    ...
                                    <a href="{{ route('auth.register.rt-rw') }}" class="text-underline">RT/RW</a>
                                    Atau
                                    <a href="{{ route('auth.register.warga') }}" class="text-underline">Warga</a>
                                </p>
                            </form>
                        </div>
                    </div>
