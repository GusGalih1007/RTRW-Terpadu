                ...
                <div class="col-md-10">
                    <div class="card card-transparent auth-card d-flex justify-content-center mb-0 shadow-none">
                        <div class="card-body">
                            ...
                            @endif
                            <h2 class="mb-2 text-center">Register Warga</h2>
                            <p class="text-center">Masukkan Email dan password anda mendaftar sebagai warga</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Konfimasi Password..." class="form-control" required>
                                        </div>
                                    </div>
