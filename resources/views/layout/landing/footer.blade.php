<footer>
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="../dashboard/index.html" class="navbar-brand d-flex align-items-center">
                        ...
                        <h4 class="logo-title ms-3 text-white">RT/RW Terpadu</h4>
                    </a>
                    ...
                    <div class="d-flex align-items-center mb-3 pt-2">
                        ...
                        <p class="mb-0 ms-4 text-white">2798 Meadow Lane, Napa, California- 94559</p>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <p class="mb-0 ms-4 text-white">(808) 555-0111</p>
                    </div>
                </div>
                <div class="col-md-2 mt-md-0 mt-4">
                    <h5 class="mb-4 text-white">Links</h5>
                    <ul class="list-unstyled m-0 p-0 text-white">
                        <li class="mb-3">
                            <svg class="text-primary me-2" width="7" height="8" viewBox="0 0 7 8"
                                fill="none">
                ...
                <div class="col-md-4 mt-md-0 mt-4">
                    ...
                    <ul class="list-unstyled d-flex social-icon m-0 mt-4 p-0">
                        <li>
    ...
    <div class="footer-bottom bg-secondary">
        <div class="footer-border container py-4">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <p class="mb-0">©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> RT/RW Terpadu, All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
