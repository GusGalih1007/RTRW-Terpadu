    ...
    <div class="offcanvas-body data-scrollbar">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-grid mb-4 grid-cols-3 gap-3">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-3 mt-4">Color Customizer</h5>
                    <button class="btn btn-transparent border-0 p-0" data-value="theme-color-default"
                ...
                <div class="d-grid mb-4 grid-cols-5 gap-x-2">
                ...
                <div class="d-grid mb-4 grid-cols-2 gap-3">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/settings/dark/01.png')}}" alt="ltr"
                            class="mode dark-img img-fluid btn-border flex-column active mb-2 p-0"
                            data-setting="dir-mode" data-name="dir" data-value="ltr">
                        <img src="{{ asset('assets/images/settings/light/01.png')}}" alt="ltr"
                            class="mode light-img img-fluid btn-border flex-column active mb-2 p-0"
                            data-setting="dir-mode" data-name="dir" data-value="ltr">
                        <span class="mt-2"> LTR </span>
                    </div>
                    <div class="text-center">
                        <img src="{{ asset('assets/images/settings/dark/02.png')}}" alt=""
                            class="mode dark-img img-fluid btn-border flex-column mb-2 p-0" data-setting="dir-mode"
                            data-name="dir" data-value="rtl">
                        <img src="{{ asset('assets/images/settings/light/02.png')}}" alt=""
                            class="mode light-img img-fluid btn-border flex-column mb-2 p-0" data-setting="dir-mode"
                            data-name="dir" data-value="rtl">
                        <span class="mt-2"> RTL </span>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <h5 class="mb-3 mt-4">Sidebar Color</h5>
                <div class="d-grid mb-4 grid-cols-2 gap-3">
                ...
                <hr class="hr-horizontal">
                <h5 class="mb-3 mt-4">Sidebar Types</h5>
                <div class="d-grid mb-4 grid-cols-3 gap-3">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/settings/dark/03.png')}}" alt="mini"
                            class="mode dark-img img-fluid btn-border flex-column mb-2 p-0" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-mini">
                        <img src="{{ asset('assets/images/settings/light/03.png')}}" alt="mini"
                            class="mode light-img img-fluid btn-border flex-column mb-2 p-0" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-mini">
                ...
                <hr class="hr-horizontal">
                <h5 class="mb-3 mt-4">Sidebar Active Style</h5>
                <div class="d-grid mb-4 grid-cols-2 gap-3">
                    <div class="text-center">
                    ...
                    <div class="text-center">
                        <img src="{{ asset('assets/images/settings/dark/09.png')}}" alt="pill-all"
                            class="mode dark-img img-fluid btn-border flex-column p-0" data-setting="sidebar"
                ...
                <hr class="hr-horizontal">
                <h5 class="mb-3 mt-4">Navbar Style</h5>
                <div class="d-grid grid-cols-2 gap-3">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/settings/dark/11.png')}}" alt="image"
                            class="mode dark-img img-fluid btn-border flex-column mb-2 p-0" data-setting="navbar"
                        ...
                        <img src="{{ asset('assets/images/settings/light/10.png')}}" alt="image"
                            class="mode light-img img-fluid btn-border flex-column mb-2 p-0" data-setting="navbar"
                            data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                    ...
                    <div class="btn btn-border active d-block col-span-full mt-4" data-setting="navbar"
                        data-name="navbar-default" data-value="default">
