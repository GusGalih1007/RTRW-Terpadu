                    ...
                    <form method="POST"
                        ...
                        @if (Auth::user()->role->roleName === 'SYSAdmin')
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="kodeKabupaten" class="form-label">Kabupaten/Kota <span
                                ...
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="kodeKelurahan" class="form-label">Kelurahan/Desa <span
                                            class="required">*</span></label>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <textarea name="alamatDetail" class="form-control" id="alamatDetail" placeholder="Jl. Manggis No. 3...">{{ old('alamatDetail', $data->alamatDetail ?? '') }}</textarea>
                            </div>
                        </div>
